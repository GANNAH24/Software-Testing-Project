...
// Reset selected time slot whenever doctor or date changes
useEffect(() => {
  setSelectedTimeSlot(""); // clear previous selection
}, [selectedDoctor, selectedDate]);
  ...
  const fetchAvailableSlots = async () => {
    ...
    try {
      const response = await scheduleService.availableSlots(
        selectedDoctor,
        selectedDate
      );
                  ...
                  <div className="space-y-3">
                    {doctors.map((doctor) => (
                      <button
                        ...
                        onClick={() =>
                          setSelectedDoctor(doctor.user_id || doctor.doctor_id)
                        }
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="text-gray-900">
                        {
                          doctors.find(
                            (d) => (d.id || d.doctor_id) === selectedDoctor
                          )?.name
                        }
                      </span>
                    </div>
